...
angular.module('kitchensink', ['membersService','flightService','bookingService','2bookingService','texiService','2membersService','hotelService','3bookingService','3membersService']).config(
